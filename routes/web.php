...
Route::group(['namespace'=>'Personal', 'middleware' => 'auth'], function () {   
    ...
    Route::post('/chat/sendFile', 'DirectController@uploadFile');

    //video 
    Route::get('/video/index', 'DirectController@video');
    Route::post('/video/call-user', 'DirectController@callUser');
    Route::post('/video/accept-call', 'DirectController@acceptCall');
}); 
//home page
...
Route::group(['prefix'=>'twilio'], function () {  
    ...
    Route::get('list/chat/{channel}', 'Twilio\ChatController@list')->name('messages.list');
