...
@section('content')
    <section class=" hej">
        <form method="POST" action="{{ route('upload.video')}}" class="dropzone hek " id="dropzoneForm"
        ...
        <form method="POST" action="{{ route('upload.video')}}">
            ...
            <div class="detail-video">
                ...
                <div class="clr hec">
                    ...
                    <span class="os fs-14" style="line-height:30px">IGTV and Facebook Page</span><br><a
                            class="text-blue">Connect Page</a>
                </div>
                <p class="os fs-11">Reach more people by making your videos visible on IGTV and your Facebook Page.</p>
                <br><br>
                <b>Accessibility</b>
                <div class="hec">
                    <input type="checkbox" value="1" name="v_status">Auto-Generated Captions
                    <p class="fs-11">Auto-generated captions added to your video help people with hearing impairments.
                        They are only available on the iOS and Android apps and may take a few minutes to appear.</p>
                </div>
