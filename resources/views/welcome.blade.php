            ...
            <div class="d-inline-block left border-gray">
                <section>
                    <ul class="d-flex story position-relative mySlides">
                        <li>
                            <a>
                                <img src="{{ asset('img/be-giang.png') }}"
                                     class="img-story rounded-circle d-inline-block">
                                <div>42</div>
                            </a>
                        </li>
                        <li>
            ...
            <div class="d-inline-block right">
                <div class="d-block">
                    ...
                    <div class="d-inline-block">
                        <div class="user-link"><a href="{{Auth::user()->user}}"
                                                  class="text-black">{{ Auth::user()->user}}</a></div>
                        <div class="user-name">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="" class="text-black fs-12"
                           style="text-align:right;width:68%">{{ __('translate.See All')}}</a>
                    </div>
                    @foreach($user as $list)
                        @if(!Follow::where(['user_id'=>Auth::id(), 'followed'=>$list->id])->count())
                            <div class="d-inline-block position-relative suggest">
                                ...
                                <div class="d-inline-block"
                                     style="position: absolute; top: 0;right: 0;margin-top: 10px;">
                                    <p class="cs follow{{$list->id}}  text-blue"
                                       onclick="follow('{{$list->id}}')">{{ ucwords(__('translate.follow'))}}</p>
                    ...
                    <div class="about-us">
                        <ul style="line-height:20px;margin-top: 30px;font-size:12px;opacity: 0.5;">
                            ...
                            <li class="d-inline-block "><a href="{{route('language',['vi']) }}">Tiếng Việt</a> &#8226;
                            </li>
                            <li class="d-inline-block "><a
                                        href="{{ route('login-activity') }}">{{ __('translate.Locations')}}</a> &#8226;
                            </li>
                        </ul>
                        <br>
                    </div>
