<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>@if(!$role_count)
                Hiện tại bạn chỉ có thể xem trang này. Liên hệ admin để thêm quyền hạn
            @endif</small>
    </div>
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        @foreach($admin as $key => $list)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a data-title="Cảnh báo !" href="{{ route('admin.edit', $list->id)}}"
                                       class="btn btn-sm btn-primary mr-4 twitter">Cập nhật</a>
