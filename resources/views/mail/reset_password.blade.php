...
<div class="body"><br>
    ...
    <div class="p-15">
        ...
        <p>Chúng tôi rất tiếc khi biết bạn đang gặp sự cố khi đăng nhập vào Instagram. Chúng tôi có thể giúp bạn đổi mật
            khẩu tài khoản của mình.</p>
        <div style="text-align:center"><a href="{{route('user.change.password', 'user='.$user)}}" class="button"
                                          style="color:white">Đăng nhập với tư cách {{$user}}</a></div>
