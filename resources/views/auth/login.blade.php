...
<script>
     $(function(){
          if($('#username').val().length){
               $(".label-user").css({"font-size":"11px","transform":"translateY(-11px)"});
          }
          $(".label-user").on('click',function(){
               $(this).css({"font-size":"11px","transform":"translateY(-11px)"});
          })
          $("#username").on("keyup",function(){
               ...
               if(x.value.length>0){
                    ...
                    $(".label-user").css({"font-size":"15px","transform":"translateY(0px)"});
               }
          })
          if($('#password').val().length){
               $(".label-password").css({"font-size":"11px","transform":"translateY(-11px)"});
          }
          ...
          $("#password").on("keyup",function(){
               ...
               if(x.value.length>0){
                    ...
                    $(".label-password").css({"font-size":"15px","transform":"translateY(0px)"});
               }
          }) 
     })
</script>
