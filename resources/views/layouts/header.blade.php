...
<header>
        ...
        <div style="display: flex;justify-content:space-between;">
            ...
            <ul class="d-flex">
                ...
                <notification v-bind:notifications="notifications"
                              v-bind:notification_readed="notification_readed"></notification>
                <li class="position-relative set-user">
                    <a>
                        <img src="{{ pare_url_file(auth()->user()->avatar, 'user') }}"
                             class="mr-20 rounded-circle w-30 avatar_user_uploaded">
                    </a>
    ...
    <div id="myModal-1" class="modal">
        <div class="modal-content setting animate__animated animate__zoomIn" style="text-align:center">
            <li class="one"><label style="font-size: 20px;">QRCODE</label><span class="float-right cs" id="exit1"
                                                                                style="right: 15px;position: absolute;top: 0;font-size: 33px;">&times;</span>
            </li>
