            ...
            <div class="edit-form__left">
                <ul class="cs">
                    <a href="{{route('profile.edit')}}">
                        <li class="{{ Route::currentRouteName() == 'profile.edit' ? 'activate' : 'noactivate'}}">{{__('translate.Edit Profile')}}</li>
                    </a>
                    <a href="{{route('password.edit')}}">
                        <li class="{{ Route::currentRouteName() == 'password.edit' ? 'activate' : 'noactivate'}}">{{__('translate.Change Password')}}</li>
                    </a>
                    <a href="{{ route('login-activity') }}">
                        <li class="{{ Route::currentRouteName() == 'login-activity' ? 'activate' : 'noactivate'}}">{{__('translate.Login Activity')}}</li>
                    </a>
                </ul>
            </div>
