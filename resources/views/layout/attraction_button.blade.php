@php
    use App\Models\Like;$class=" fa-heart-o ";
    if(Like::checkLove($value))
...
<div class="d-flex" style="align-items: center;justify-content: space-between;width: 100px;">
    ...
    <a href="{{pare_url_file($val->p_image, 'profile/img') }}" download title="{{$val->p_image}}"> <span
                class="fa-stack fa-lg"><i class="fa fa-download fa-stack-1x"></i></span>
    </a>
</div>
<script>
    $(function () {
