        ...
        <form action="{{ route('profile.store')}}" method="POST" class="form-question">
            ...
            <div class="clr">
                ...
                <div class="edit-form__content">
                    ...
                    <p class="os f-11">
                        {{ __("translate.Help people discover your account by using the name you're known by: either your full name, nickname, or business name.You can only change your name twice within 14 days") }}.
                    </p>
                </div>
            </div>
            ...
            <div class="clr">
                ...
                <div class="edit-form__content">
                    <input type="text" disabled value="{{Auth::user()->user}}"
                           placeholder="{{ __('translate.Username') }}">
            ...
            <div class="clr">
                ...
                <div class="edit-form__content">
                    <input type="text" name="website" placeholder="{{ __('translate.Website') }}"
            ...
            <div class="clr">
                ...
                <div class="clr">
                    ...
                    <div class="edit-form__content">
                        <form action="confirm" method="get">
                            ...
                            <button class="background-blue button"
                                    type="submit">{{ __('translate.Confirm Phone Number') }}</button>
                        </form>
                    </div>
                </div>
                @php
                ...
                <div class="clr">
                    ...
                    <div class="edit-form__content">
                        <input type="text" name="gender" class="cs" placeholder="Email" id="myBtn-6" value="{{ $val}}"
                               readonly>
                    </div>
                </div>
                <div id="myModal-6" class="modal">
                    <div class="modal-content setting animate__animated animate__zoomIn">
                        ...
                        <div class="clr gender">
                            <div>
                                <input type="radio" id="one" class="gender" name="gender"
                                       value="1" {{ Auth::user()->gender ==1 ? "checked" : ''}}>
                                <label for="one">{{ __('translate.Male')}}</label><br>
                                <input type="radio" id="two" class="gender" name="gender"
                                       value="2" {{ Auth::user()->gender ==2 ? "checked" : ''}}>
                                <label for="two">{{ __('translate.Female')}}</label><br>
                                <input type="radio" id="three" class="gender" name="gender"
                                       value="3" {{ Auth::user()->gender ==3 ? "checked" : ''}}>
                                <label for="three">{{ __('translate.Custom')}}</label><br>
                                <input type="radio" id="four" class="gender" name="gender"
                                       value="4"{{ Auth::user()->gender ==4 ? "checked" : ''}}>
                        ...
                        <div class="text-center">
                            <button type="submit" class="background-blue update_gender buttons">
                                ...
                                <img src="{{ asset('img/loading.gif')}}" class="uploadavatars w-30"
                                     style="display:none;">
                            </button>
                        </div>
                        <br>
