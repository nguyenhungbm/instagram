   ...
   <div class="card-body">
      <form  action="{{ route('role.update',$role->id)}}" method="post">
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" value="{{ $role->display_name}}" name="display_name" id="exampleFormControlInput2"  >
         ...
         <div class="card-body text-primary col-md-3">
            <h5 class="card-title">
               <input type="checkbox" id="de" name="" 
                  value="" class="checkbox_all">
