...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Phân quyền</h1>
        ...
        <div class="table-responsive">
          ...
          @foreach($role as $list)
              <tr>
                ...
                <td>
                <a href="{{ route('role.edit',$list->id)}}" class="btn btn-sm btn-primary">Sửa</a>
                <form action="{{ route('role.destroy',$list->id)}}" method="post">
                  @method('DELETE')
                  @csrf
                  <button class="btn btn-sm btn-danger">  Xoá</button></td>
                </form>
              </tr>
                      @endforeach
            </tbody>
