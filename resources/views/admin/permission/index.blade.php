                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <a href="{{ route('admin.permission.update',$list->id)}}" class="btn btn-sm btn-primary">Sửa</a>
                        <a href="{{ route('admin.permission.delete',$list->id)}}" class="btn btn-sm btn-danger">Xoá</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
