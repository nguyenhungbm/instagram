...
<div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" value="{{$admin->name}}" id="exampleFormControlInput2"  >
                ...
                @endif
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="email" class="form-control" value="{{$admin->email}}" id="exampleFormControlInput1" placeholder="name@example.com">
