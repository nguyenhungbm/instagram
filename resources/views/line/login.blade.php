...
<div>
    <div class="red">Email :</div>
    <span id="email"></span></div>
<div>
    <div class="red">AccessToken :</div>
    <span id="AccessToken"></span></div>
<div>
    <div class="red">IDToken :</div>
    <span id="IDToken"></span></div>
<div>
    <div class="red">DecodedIDToken :</div>
    <span id="DecodedIDToken"></span></div>
<div>
    <div class="red">Avatar :</div>
    <img src="" alt="" id="picture" style="height:150px;width:150px"></div>
<div>
    <div class="red">statusMessage :</div>
    <span id="statusMessage"></span></div>
<div>
    <div class="red">Loại màn hình :</div>
    <span id="context"></span></div>
<div>
    <div class="red">Môi trường :</div>
    <span id="environment"></div>
<div>
    <div class="red">Ngôn ngữ :</div>
    <span id="language"></span></div>
<div>
    <div class="red">Phiên bản Liff :</div>
    <span id="version"></span></div>
<div>
    <div class="red">Liff App có chạy trên Liff browser :</div>
    <span id="isCLient"></span></div>
<div>
    <div class="red">Tình trạng bạn bè giữa người dùng và tài khoản Liff Official :</div>
